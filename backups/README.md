...
**Fecha:** 25/11/2025, 3:44:26 p.m.
**Duración:** 159.93 segundos
**Base de datos:** postgres

## Archivos Generados

### 1. Estructura de la Base de Datos
- **Archivo:** `estructura_erp_2025-11-25T21-41-48.sql`
- **Tamaño:** 0.04 MB
- **Contenido:** Definiciones DDL (CREATE TABLE, índices, constraints, etc.)
- **Uso:** Restaurar la estructura de las tablas

### 2. Datos Completos
- **Archivo:** `datos_completos_2025-11-25T21-42-12.sql`
- **Tamaño:** 1.98 MB
...
psql "postgresql://[usuario]:[contraseña]@[host]:[puerto]/[database]" -f backups/estructura_erp_2025-11-25T21-41-48.sql

# 2. Luego restaurar los datos
psql "postgresql://[usuario]:[contraseña]@[host]:[puerto]/[database]" -f backups/datos_completos_2025-11-25T21-42-12.sql
```

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm border border-blue-200">
          <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-semibold text-blue-900">Proyección (Estimado)</h4>
          </div>

          <div className="space-y-3">
            <div className="flex justify-between items-center pb-2 border-b">
              <span className="text-gray-700">Ingreso Estimado</span>
            ...
            <div className="flex justify-between items-center pb-2 border-b border-blue-300">
              <span className="font-medium text-gray-800">Utilidad Estimada</span>
            ...
            <div className="flex justify-between items-center bg-blue-50 p-3 rounded">
              <span className="font-medium text-gray-800">Margen Estimado</span>

-- ============================================
-- FIX: Corregir fórmula de utilidad_real en la vista
-- ============================================
--
-- FÓRMULA CORRECTA:
-- Utilidad = Ingresos - Gastos - Provisiones
--
-- Las provisiones son compromisos de gasto (futuras compras)
-- que se deben restar de la utilidad.
-- ============================================
...
WHERE clave_evento = 'TEST-CALC-001'
   OR nombre_proyecto ILIKE '%DOTERRA%'
ORDER BY id;
